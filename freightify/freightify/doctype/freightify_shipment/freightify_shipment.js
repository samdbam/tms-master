...
frappe.ui.form.on("Freightify Shipment", {
	refresh(frm) {
            ...
            frm.add_custom_button(
                ...
                function () {
                    erpnext.utils.map_current_doc({
                        method: "freightify.freightify.doctype.freightify_shipment.freightify_shipment.make_freightify_shipment",
...
frappe.ui.form.on('Sales Order Item',{
    item_code(frm,cdt,cdn){
        ...
        if(d.item_code && (!d.item_name || !d.uom || !d.conversion_factor)){
            frm.call({
                method: "freightify.freightify.doctype.freightify_shipment.freightify_shipment.get_item_detail",
                args: {
    ...
    before_items_remove(frm,cdt,cdn) {
        ...
        if(d.custom_schedule_and_rate_ref){
            ...
            if(check_selected==0){
                ...
                var schdeule_rate_table=frm.doc.schedule_and_rate
                frm.call({
                    method: "freightify.freightify.doctype.freightify_shipment.freightify_shipment.consolidate_shipment_item",
                    args: {
                        table:schdeule_rate_table,
                        doctype:"Freightify Shipment"
                    },
...
function check_existing(frm,doctype){
    frm.call({
        method: "freightify.freightify.doctype.freightify_shipment.freightify_shipment.check_shipment_shedule_and_rate",
        args: {
            doc:frm.doc,
            doctype:doctype
        },
